...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: black;"><b>Rental Motor Sultan <br/><marquee direction="left" scrollamount="2" align="center"><i style="color :aqua;">Senggol dong Boss!!</i></b></marquee></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: white;"> Copyright &copy; RMS Senggol Dong Boss!! - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
