	    ...
	    <div class="col-md-12">
	        <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a href="data/motortambah"><button class="btn btn-primary">
						<i class="fa fa-plus"> </i> Tambah Motor</button></a>
					<?php }?>
                </div>
				<!-- /.box-header -->
				<div class="box-body">
                        ...
                        <?php $no=1;foreach($Motor->result_array() as $isi){?>
                            <tr>
                                ...
                                <td><?= $isi['tgl_masuk'];?></td>
									...
									<?php if($this->session->userdata('level') == 'Petugas'){?>
									<a href="<?= base_url('data/motoredit/'.$isi['id_motor']);?>"><button class="btn btn-success"><i class="fa fa-edit"></i></button></a>
									<a href="<?= base_url('data/motordetail/'.$isi['id_motor']);?>">
									<button class="btn btn-primary"><i class="fa fa-sign-in"></i> Detail</button></a>
                                    <a href="<?= base_url('data/prosesmotor?motor_id='.$isi['id_motor']);?>" onclick="return confirm('Anda yakin Motor ini akan dihapus ?');">
