      ...
      <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview <?php if($this->uri->uri_string() == 'data/kategori'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/showroom'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/motortambah'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/motordetail/'.$this->uri->segment('3')){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/motoredit/'.$this->uri->segment('3')){ echo 'active';}?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
                        ...
                        <a href="<?php echo base_url("data");?>" class="cursor">
                            <span class="fa fa-book"></span> Data Motor
                    ...
                    <li class=" <?php if($this->uri->uri_string() == 'data/showroom'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/showroom");?>" class="cursor">
                            <span class="fa fa-list"></span> Showroom
			...
			<?php if($this->session->userdata('level') == 'Anggota'){?>
				...
				<?php if($this->uri->uri_string() == 'data/motordetail/'.$this->uri->segment('3')){ echo 'active';}?>">
					<a href="<?php echo base_url("data");?>" class="cursor">
						<i class="fa fa-search"></i>  <span>Cari Motor</span>
					</a>
				</li>
