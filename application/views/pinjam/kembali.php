								...
								<table class="table table-striped">
									...
									<tr>
										...
										<?php 
												...
												if($diff > 0 )
												{
													...
													</p><small style="color:#333;">* Untuk '.$jml.' Motor</small>';
												}else{
									...
									<tr>
										...
										<?php
											...
											foreach($pin as $isi)
											{
												$motor = $this->M_Admin->get_tableid_edit('tbl_motor','motor_id',$isi['motor_id']);
												echo $no.'. '.$motor->motor_id.'<br/>';
											$no++;}
...
<h4 class="modal-title"> Pengembalian Motor</h4>
</div>
<div id="modal_body" class="modal-body fileSelection1">
	<table class="table table-striped">
		<tr style="background:yellowgreen">
			<td colspan="3">Data Peminjaman Motor</td>
		</tr>
		<tr>
			<td>No Peminjaman</td>
			<td>:</td>
		...
		<tr>
			...
			<?php
				...
				{
					$motor = $this->M_Admin->get_tableid_edit('tbl_motor','motor_id',$isi['motor_id']);
					echo $no.'. '.$motor->motor_id.' ( '.$motor->merk.' )<br/>';
				$no++;}
